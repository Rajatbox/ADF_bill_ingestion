...
SELECT 
    ...
    TRIM(CAST(d.[Express or Ground Tracking ID] AS nvarchar(255))) AS express_or_ground_tracking_id,
    TRIM(CAST(d.[MPS Package ID] AS nvarchar(255))) AS msp_tracking_id,
